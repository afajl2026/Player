...
class BERTPlayer(Player):
    PLAYER_NAME = "BERT Baseline Student Player"  # name for the player

    def __init__(self):
        super().__init__(self.PLAYER_NAME)
        self.model_path = './finetuned_student_model'
        self.model = DistilBertForSequenceClassification.from_pretrained(self.model_path, num_labels=1)
